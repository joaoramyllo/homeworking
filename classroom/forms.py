...
from classroom.models import Answer, Question, Student, StudentAnswer, Subject, User, List, Avatar
...
class TakeQuizForm(forms.ModelForm):
    answer = forms.ModelChoiceField(queryset=Answer.objects.none(), widget=forms.RadioSelect(), required=True, empty_label=None)
...
class PrimaryAvatarForm(forms.Form):
    answer = forms.ModelChoiceField(queryset=Avatar.objects.none(), widget=forms.RadioSelect(), required=True, empty_label=None)
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.fields['choice'] = forms.ChoiceField(label=_("Choices"),choices=choices,widget=widgets.RadioSelect)
    """
